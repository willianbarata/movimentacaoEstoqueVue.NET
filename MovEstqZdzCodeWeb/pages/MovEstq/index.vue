  ...
  >
    <template v-slot:top>
      <v-toolbar
        flat
      >
        <v-toolbar-title> Movimentação de Estoque </v-toolbar-title>
        <v-divider
          class="mx-4"
          inset
          vertical
    ...
    data: () => ({
      ...
      emppes: [],
        headers: [
          ...
          { text: 'Empresa / Pessoa', align: 'center', value: 'EmpPesID' },
          { text: 'Valor Total', align: 'center', value: 'clienteFornecedor' },
          { text: 'Entrada / Saída', align: 'center', value: 'entradaSaida' },
      ...
      async initialize () {
        try {
            var response = await this.$axios({
               method: "GET",
               url: 'https://localhost:7009/movestq'
            });
